...
export class HomeComponent implements OnInit {
  ...
  private createChart(): void {
    const chart = createChart(document.getElementById('lwc'), {
      height: 300,
      layout: {
    ...
    const chart1 = createChart(document.getElementById('lwc-1'), {
      height: 300,
      layout: {
        backgroundColor: 'transparent'
      }
    });
    const chart2 = createChart(document.getElementById('lwc-2'), {
      height: 300,
      layout: {
        backgroundColor: 'transparent'
      }
    ...
    function mergeTickToBar(price) {
      ...
      candleSeries1.update(currentBar);
      candleSeries2.update(currentBar);
    }
